...
Devido a experiências anteriores com o framework .NET da Microsoft e por haver um aparelho Nokia Lumia 800 disponível, optou-se por criar um aplicativo para Windows Phone 7 (WP7) e um novo modelo de arquitetura. Este aparelho, lançado no final de 2011, possuia diversos sensores inovadores, como câmera de 8.0 MP, acelerômetro, aproximidade e bússola magnética. Seria então necessário novos paradigmas para receber e armazernar os dados enviados deste novo aplicativo, Figura \ref{fig:wp7}.
