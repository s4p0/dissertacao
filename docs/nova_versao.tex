...
Para a validação do conceito desenvolvido neste trabalho, utilizou-se o aplicativo híbrido (ver Seção \ref{ssub:aplicativo_com_biblioteca_hibrida}) na área de estudo para captar imagens, vídeos e áudios aleatórios da área de estudo, mas que tenham algum ponto de interesse relevantes ao projeto, como desmatamento, clareiras, fazendas ou fauna. Áreas de clareiras, por exemplo, podem representar diferentes formas em uma imagem de pequena resolução (250 m) podendo parecer imperceptível, mas com estas fotos in-situ é possível eliminar falsos-positivo.
...
Esta pequena janela possui, na primeira linha, possui diferente conteúdo conforme dado selecionado. Caso venha ser uma imagem, são exibidos as diferentes dimensões desta imagem, caso seja um áudio ou vídeo, uma janela é exibida com o respectivo conteúdo pronto para reprodução, Figura \ref{fig:detalhes_conteudos}.
\begin{figure}%
\centering
\includegraphics[width=0.4\textwidth]{figuras/resultados/detalhe_video.png}
\includegraphics[width=0.4\textwidth]{figuras/resultados/detalhe_audio.png}
\qquad
\includegraphics[width=0.4\textwidth]{figuras/resultados/detalhe_foto.png}
\includegraphics[width=0.4\textwidth]{figuras/resultados/selecao_imagem_foto.png}
\caption{No canto superior esquerdo, uma amostra de um vídeo capturado e pronto para exibição. No canto superior direito, uma gravação de áudio pronto para ser reproduzido. Na parte inferior esquerda o detalhe de exibição de uma foto e ao seu lado a seleção da imagem com melhor resolução, com link para efetuar o download.}%
...
%                 \includegraphics[width=\textwidth]{figuras/resultados/detalhe_audio.png}
%                 % \caption{A gull}
%                 % \label{fig:gull}
%         \end{subfigure}%
...
%         \begin{subfigure}{0.3\textwidth}
%                 \includegraphics[width=\textwidth]{figuras/resultados/detalhe_video.png}
%                 % \caption{A tiger}
%                 % \label{fig:tiger}
%         \end{subfigure}
%         ~ %add desired spacing between images, e. g. ~, \quad, \qquad, \hfill etc.
%           %(or a blank line to force the subfigure onto a new line)
%         \begin{subfigure}{0.3\textwidth}
%                 \includegraphics[width=\textwidth]{figuras/resultados/detalhe_foto.png}
%                 % \caption{A mouse}
%                 % \label{fig:mouse}
%         \end{subfigure}
...
Os mapas de fundo são obtidos utilizando o componente OpenLayers2 que busca as informações geográficas diretamente do projeto OpenStreetMaps.

Os mapas exibidos de fundo na Figura \ref{fig:mapa_fullscreen} são mapas do serviço OpenStreetMap, utilizando o componente OpenLayers2. Este componente pode ser configurado para exibir diversas outras canadas.

Assim, foram adicionadas outras camadas para o componente conforme Figura \ref{fig:layers_menu}.

\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{figuras/resultados/layers_menu.png}
\caption{Menu.}
