...
Após verificar a utilização de um aplicativo de sistemas prontos, optou-se por desenvolver cada aplicativo com a suas próprias ferramentas. Cada fabricante de dispositivos móveis disponibiliza conjuntos de códigos a serem utilizados por um desenvolvedor de aplicativos, estes conhecido por biblioteca, \textit{API} ou \textit{SDK}. A maioria dos fabricantes disponibilizam essas bibliotecas sem custos, porém, para poder publicar um aplicativo as lojas online cobram uma assinatura anual que variam de acordo com cada fabricante (Tabela \ref{tab:tabela_custo}).
...
Na Tabela \ref{tab:tabela_custo}, as plataformas mostradas são referentes a pesquisa realizada por \citeonline{IDC:2014Q3}, que ilustra as plataformas mais utilizadas trimestralmente desde 2011 até o penúltimo trimestre de 2014.
