...
\begin{figure*}[htb]
\centering
\includegraphics[keepaspectratio,width=0.9\textwidth]{figuras/epicollect/03_FORM_ANTIGO.png}
...
\begin{figure*}[htb]
\centering
\includegraphics[keepaspectratio,width=0.9\textwidth]{figuras/pertinencia.png}
...
\begin{figure*}[htb]
\centering
\includegraphics[keepaspectratio,width=0.9\textwidth]{figuras/epicollect/05_ALL_EPICOLLECT_DATA.png}
...
Outra plataforma de sistemas prontos foi avaliado, Sensr, porém só existe um aplicativo para a plataforma iOS. Assim estes dois protótipos foram criados, mas não utilizados devido a falta de estrutura apresentados pelos sistemas pronto em realação a mais de uma plataforma.
