...
A camada de exibição, interface ou front-end para este projeto foi criado a partir de uma única página HTML5 com o auxilio dos seguintes frameworks:

\begin{enumerate}
    \item Twitter Bootstrap. Este framework para desenvolvimento de interface gráfica permite novas criações de forma rápida e simples. Conhecido por permitir um desenvolvimento rápido para dispositivos móveis, o Bootstrap, possui diversas funcionalidades que são acessados através da utilização de JavaScript com CSS.
    \item OpenLayers 2. Um dos primeiros e mais utilizados frameworks para exibição de dados geográficos, o OpenLayers, possui diversas funcionalidades para mostrar gráficos em uma página HTML.
    \item jQuery. Diversas funcionalidades do JavaScript são encapsuladas atravéss deste framework tornando o desenvolvimento de páginas dinâmicas mais simples. o jQuery permite fazer chamadas XMLHttpRequest (XHR) de forma fácil, essas chamadas características de páginas dinâmicas, permitem carregar conteúdos de servidores remotos e atualizar a página em exibição.
    \item Sly. Este é um framework para a exibição de imagens em miniaturas onde o usuário pode, com o mouse ou com o movimento das mãos, mover as imagens de forma dinâmica.
\end{enumerate}
