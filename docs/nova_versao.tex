...
Este trabalho pondera o uso de ciência cidadã para auxiliar problemas reais, sendo um deles o monitoramento das florestas tropicais do mundo. Apesar do INPE ser pioneiro neste ramo e possuir grandes ferramentas para esta área, falta recursos para poder realizar monitoramento desta extensão e complexidade. 

O modo como o projeto ForestWatchers aborda o problema de falta de monitoramento das florestas tropicais é inovador e tangível. Novas ferramentas como a proposta neste trabalho podem aumentar significamente a precisão dos resultados obtidos pelo projeto.
