...
\section{Validação do Sistema} % (fold)
\label{sub:validacao_dos_dados}
...
Durante a validação, foi utilizado um dispositivo móvel Lumia 800, um \textit{smartphone} de sistema operacinal Windows Phone, com GPS e bússola interna. Em conjunto, utilizou-se um aparelho Garmin GPSMAP 60CSx\footnote{\url{https://buy.garmin.com/en-US/US/on-the-trail/discontinued/gpsmap-60csx/prod310.html}} para assegurar-se das coordenadas geográficas obtidas pelo dispositivo móvel e a suas precisões. 

Durante 15 dias de expedição, foram coletados 93 dados utilizando o aplicativo, sendo 83 imagens e 10 vídeos. Não foi possível efetuar captura de áudio devido a uma falha no código do aplicativo.
