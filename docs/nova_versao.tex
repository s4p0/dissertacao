...
Em uma carta enviada a revista Nature\footnote{\url{http://www.nature.com/}} no ano de 2005, \citeonline{Ramos2005} argumenta se a iniciativa de um novo sistema de monitoramento não está próximo. Um sistema que utilize tecnologias de computação distribuída aplicado a catalogos de imagens da Terra de acesso livre com alta resolução, seria possível monitorar partes da floresta mundial usando a Internet.
