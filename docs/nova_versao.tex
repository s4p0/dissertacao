...
\begin{enumerate}[label=\arabic*.]
    ...
    \item Áudio. Representação de um dado de áudio.
    \begin{enumerate}[label=\alph*.]
        \item Áudio em navegação
    \end{enumerate}
    \item Foto. Representação de um dado de foto.
    \begin{enumerate}[label=\alph*.]
        \item Foto em navegação
    \end{enumerate}
    \item Vídeo. Representação de um dado de vídeo.
    \begin{enumerate}[label=\alph*.]
        \item Vídeo em navegação
        \item Janela de Propriedades do vídeo
        \item Exibição do conteúdo do vídeo
        \item Propriedades do vídeo
...
\begin{figure}[htb]
\centering
\includegraphics[width=0.9\textwidth]{figuras/frontend_mocqup.png}
\caption{;}
...
Para o desenvolvimento desta página foi necessária a utilização dos frameworks Twitter Bootstrap, OpenLayers 2, jQuery e Sly.

O Twitter Bootstrap\footnote{\url{http://getbootstrap.com}} é um framework para desenvolvimento de interface gráfica permite novas criações de forma rápida e simples. Conhecido por permitir um desenvolvimento rápido para dispositivos móveis, o Bootstrap, possui diversas funcionalidades que são acessados através da utilização de JavaScript com CSS.

Um dos primeiros e mais utilizados frameworks para exibição de dados geográficos, o OpenLayers\footnote{\url{http://openlayers.org/two/}}, possui diversas funcionalidades para mostrar gráficos em uma página HTML.

Diversas funcionalidades do JavaScript são encapsuladas atravéss deste framework tornando o desenvolvimento de páginas dinâmicas mais simples. O jQuery\footnote{\url{http://jquery.com/}} permite fazer chamadas XMLHttpRequest (XHR) de forma fácil, essas chamadas características de páginas dinâmicas, permitem carregar conteúdos de servidores remotos e atualizar a página em exibição.

Sly\footnote{\url{http://darsa.in/sly/}}, este é um framework para a exibição de imagens em miniaturas onde o usuário pode, com o mouse ou com o movimento das mãos, mover as imagens de forma dinâmica.
