...
Um projeto da universidade de Oxford que irá investigar o envolvimento do público na ciência do século 19 e 21, receberá o financiamento de quase 2 milhões de libras para realizar seus estudos \cite{conscicom2014}. Supõe-se que este estudo poderá entender e desenvolver novas ferramentas para trocar informações entre cientistas profissionais e legiões de voluntários \cite{Leicester2013}. 
...
Este capítulo descreve a metodologia utilizada em cada etapa da construção do módulo, por fim, detalha o experimento de coleta de dados utilizado para validação do módulo.
...
%%        Plataformas                                              & Dispositivos         & Linguagem  & Preço / Ano \\ 
