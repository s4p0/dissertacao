...
\begin{table}[h!]
     \begin{center}
	     \begin{tabular}{ c  p{5cm}  p{5cm}  p{5cm}  }
		     \toprule
		      Controle & EpiCollect+ & EpiCollect & Descrição \\ 
		    \cmidrule(r){1-1}\cmidrule(lr){2-2}\cmidrule(l){3-3}\cmidrule(l){4-4}
		     \raisebox{-\totalheight}{\includegraphics[width=0.175\textwidth]{figuras/epicollect/input_text.png}}
		      & 
		      ...
		      \end{itemize}
        		      ...
        		      Entrada de texto livre, utilizado com maior frequência para responder perguntas feitas no formulário.
                                Possui opções para ser visualizado como um rótulo do formulário, requerido, 
		      \\ 

		     \raisebox{-\totalheight}{\includegraphics[width=0.175\textwidth]{figuras/epicollect/input_numeric.png}}
		      & 
                                \begin{itemize}[topsep=0pt]
                                \item Sim
                                \end{itemize}
		     ...
		     \raisebox{-\totalheight}{\includegraphics[width=0.175\textwidth]{figuras/epicollect/input_date.png}}
		      & 
                                \begin{itemize}[topsep=0pt]
                                \item Sim
                                \end{itemize}
		     ...
		     \raisebox{-\totalheight}{\includegraphics[width=0.175\textwidth]{figuras/epicollect/input_dropdown.png}}
		      & 
                                \begin{itemize}[topsep=0pt]
                                \item Sim
                                \end{itemize}
		     ...
		     \raisebox{-\totalheight}{\includegraphics[width=0.175\textwidth]{figuras/epicollect/input_radio.png}}
		      & 
                                \begin{itemize}[topsep=0pt]
                                \item Sim
                                \end{itemize}
		     ...
		     \raisebox{-\totalheight}{\includegraphics[width=0.175\textwidth]{figuras/epicollect/input_checkbox.png}}
		      & 
                                \begin{itemize}[topsep=0pt]
                                \item Sim
                                \end{itemize}
		     ...
		     \raisebox{-\totalheight}{\includegraphics[width=0.175\textwidth]{figuras/epicollect/input_multiline.png}}
		      & 
                                \begin{itemize}[topsep=0pt]
                                \item Sim
                                \end{itemize}
		     ...
		     \raisebox{-\totalheight}{\includegraphics[width=0.175\textwidth]{figuras/epicollect/input_location.png}}
		      & 
                                \begin{itemize}[topsep=0pt]
                                \item Sim
                                \end{itemize}
		     ...
		     \raisebox{-\totalheight}{\includegraphics[width=0.175\textwidth]{figuras/epicollect/input_photo.png}}
		      & 
                                \begin{itemize}[topsep=0pt]
                                \item Sim
                                \end{itemize}
		     ...
		     \raisebox{-\totalheight}{\includegraphics[width=0.175\textwidth]{figuras/epicollect/input_video.png}}
		      & 
                                \begin{itemize}[topsep=0pt]
                                \item Sim
                                \end{itemize}
		     ...
		     \raisebox{-\totalheight}{\includegraphics[width=0.175\textwidth]{figuras/epicollect/input_audio.png}}
		      & 
                                \begin{itemize}[topsep=0pt]
                                \item Sim
                                \end{itemize}
		     ...
		     \raisebox{-\totalheight}{\includegraphics[width=0.175\textwidth]{figuras/epicollect/input_barcode.png}}
		      & 
                                \begin{itemize}[topsep=0pt]
                                \item Sim
                                \end{itemize}
