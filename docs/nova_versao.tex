...
% Para validar a metodologia, foi escolhida uma área de estudo na região nordeste

% Para validar o conceito desenvolvido neste projeto foi feita uma viagem de campo junto com a equipe do Departamento de Processamento de Imagens do INPE em Agosto de 2013. A região escolhida para o estudo fica a menos de 200km de Santarém, Pará, conhecida por Belterra. Esta região envolve a área da reserva legal dos Tapajós.

% Foram tiradas 83 fotos e 10 vídeos utilizando o aplicativo.
