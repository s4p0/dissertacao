...
O desenvolvimento de aplicativos utilizando bibliotecas nativas são mais comuns, por possuirem todas as funcionalidades oferecidas pelo fabricante do dispositivos e também por serem mais rápidos \cite{Charland:2011:Mobile}. Entretando esta forma de desenvolvimnto de aplicativos pode não ser vantajoso para uma desenvolvedor que busca alcançar o máximo de pessoas possível, para isto o aplicativo teria que ser desenvolvido em todas as plataformas possíveis (a Tabela \ref{tab:tabela_custo} mostra apenas as mais populares dos últimos anos), contando que desenvolvedor conheça todas as linguagens de programação a serem utilizadas pelas bibliotecas nativas, disponibilizadas pelos fornecedores. Assim, alguns aplicativos são mais melhores se desenvolvidos para a web, utilizando HTML,CSS e JavaScript. Grandes empresas, por exemplo, que precisam fornecer interfaces móveis das suas aplicações para seus funcionários, teriam que recorrer a primeira forma de desenvolvimento de aplicativos para poder atender a todos. (ver Figura \ref{fig:developerforce}) 

Alguns dispositivos móveis permitem a criação de aplicativos utilizando unicamente HTML5\footnote{Padrão recente da linguagem de marcação HTML.}, CSS2.0\footnote{Padrão recente da linguagem de estilo CSS.} e assim, JavaScript. Porém, nem todas as funcionalidades presentes no desenvolvimento utilizando bibliotecas nativas são encontradas utilizando esta abordagem de desenvolvimento web. 
...
%\caption{Aplicativos desenvolvidos utilizando bibliotecas nativa, não são múltipla-plataforma, mas apresentam um melhor controle e desempenho de todas suas funções. Aplicativos desenvolvidos em HTML5 tendem ser múltipla-plataforma e disponibilizar as atualizações de forma, porém apresentam funções com capacidades parciais, diferente do uso de bibliotecas nativas. O uso de bibliotecas híbridas oferece o desenvolvimento do mesmo aplicativo para demais plataformas com capacidade total das funções do dispositivo. Adaptada de \cite{Korf2013}.}
