...
Informação Geográfica Voluntariada surgiu com a chegada da internet rápida, da \textit{Web} 2.0, que deu poder aos usuários de editar dinâmicamente os conteúdos de uma página e adicionar novos dados, e de ciência cidadã, onde voluntários são motivados a participarem de projetos que possam contribuir com algum propósito e muitas vezes, estes também são motivads por simplesmente ter a chance de obter-se destaque pelo seu trabalho.

Portais de mapas são utilizados de forma análogas a ferramenta \textit{wiki} onde qualquer pessoa cadastrada pode editar o conteúdo e informações ali encontradas. 

\textit{Wikimapia} é uma referência de projetos IGV, onde voluntários podem contribuir com novas informações \cite{Wikimapia:online}. O objetivo deste portal é de descrever todo o mundo com o máximo de informções utéis reunidos por voluntários, organizá-los e disponibilizá-los para o uso do público. Através de uma interface simples, figura \ref{fig:wikimapia}, para que os usuários que não possuem experiências com mapas possam também fácilmente colaborar com o projeto. Lançado em maio de 2006, não tomou muito tempo para que as pessoas viessem a conhecer a inovação e com menos de 3 meses o projeto já possuia 1 milhão de novos registros criados por voluntários. Até julho de 2012, 19 milhões de registros foram criados por voluntários \cite{Wikimapia:history}.
...
\label{ch:metodologia_resultados}
