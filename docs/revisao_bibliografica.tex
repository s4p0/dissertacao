...
%###EDITING: Com a popularização da internet, começa a aparição de projetos notáveis de ciência cidadã moderna. Em 1995, a ideia de utilizar o poder computacional de outras máquinas para se obter um número maior de processamento já era praticado. Este conceito foi iniciado por 
