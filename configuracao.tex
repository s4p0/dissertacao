...
\title{Hybrid Application for a Volunteer Sensing Module Applied for a Citizen Science Project}

%|\titulo{Um Módulo de Sensoriamento Voluntário aplicado a um Projeto de Ciência Cidadã}
\titulo{Um aplicativo híbrido para Um Módulo de Sensoriamento Voluntário aplicado a um Projeto de Ciência Cidadã}

\author{Felipe Rodolfo Santos Corrêa} %% coloque o nome do(s) autor(es)

\descriccao{Dissertação de Mestrado do Curso de Pós-Graduação em Computação Aplicada Orientada pelo Dr. Fernando Manuel Ramos e Dr. Eduardo Fávero Pacheco da Luz}
...
\valorAtributoOrientadorFICHAC{Dr. Fernando Manuel Ramos e Dr. Eduardo Fávero Pacheco da Luz} % nome(s) completo(s)
