...
\watermark{Revisão No. *02*} %% use o comando \watermark para identificar a versão de seu documento
...
%% + Sistemas de Monitoramento de Desmatamento
%% ++ Histórico
%%   ++ PRODES
%%   ++ DETER
%%
...
%% ++ Aplicativo
%%aasddasd \cite{SoaresSant:2011:EnPoAt}
%%asdasdasd ~\cite{Soares:2011:EmCiSc}
